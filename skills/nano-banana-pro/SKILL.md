...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.vilaro/vilaro.json`
...
- The script prints a `MEDIA:` line for Vilaro to auto-attach on supported chat providers.
