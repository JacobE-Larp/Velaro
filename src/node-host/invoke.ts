...
const execHostEnforced = process.env.VILARO_NODE_EXEC_HOST?.trim().toLowerCase() === "app";
const execHostFallbackAllowed = process.env.VILARO_NODE_EXEC_FALLBACK?.trim().toLowerCase() !== "0";
