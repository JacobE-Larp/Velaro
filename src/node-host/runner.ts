...
import { loadConfig, type VilaroConfig } from "../config/config.js";
...
function ensureNodePathEnv(): string {
  ensureVilaroCliOnPath({ pathEnv: process.env.PATH ?? "" });
...
function buildNodeHostLocalAuthConfig(config: VilaroConfig): VilaroConfig {
