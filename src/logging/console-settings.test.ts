...
let originalVilaroTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalVilaroTestConsole = process.env.VILARO_TEST_CONSOLE;
  process.env.VILARO_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalVilaroTestConsole === undefined) {
    delete process.env.VILARO_TEST_CONSOLE;
  } else {
    process.env.VILARO_TEST_CONSOLE = originalVilaroTestConsole;
  }
