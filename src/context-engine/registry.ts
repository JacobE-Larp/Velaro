...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("vilaro.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: VilaroConfig): Promise<ContextEngine> {
