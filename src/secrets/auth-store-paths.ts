...
export function listAuthProfileStorePaths(config: VilaroConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: VilaroConfig, stateDir: string): string[] {
