...
function resolveResolutionLimits(config: VilaroConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: VilaroConfig): SecretProviderConfig {
