...
async function runRuntimeWebTools(params: { config: VilaroConfig; env?: NodeJS.ProcessEnv }) {
...
function readProviderKey(config: VilaroConfig, provider: ProviderUnderTest): unknown {
  if (provider === "brave") {
