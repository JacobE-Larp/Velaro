const DEFAULT_TAGLINE = "All your chats, one Velaro.";
...
const TAGLINES: string[] = [
  ...
  "I'll butter your workflow like a velaro roll: messy, delicious, effective.",
  ...
  "Built by velaros, for humans. Don't question the hierarchy.",
  ...
  "You had me at 'velaro gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.VILARO_TAGLINE_INDEX;
