const DEFAULT_TAGLINE = "All your chats, one Vilaro.";
...
const TAGLINES: string[] = [
  ...
  "I'll butter your workflow like a vilaro roll: messy, delicious, effective.",
  ...
  "Built by vilaros, for humans. Don't question the hierarchy.",
  ...
  "You had me at 'vilaro gateway start.'",
