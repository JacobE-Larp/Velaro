...
vi.mock("../infra/path-env.js", () => ({
  ensureVilaroCliOnPath: ensurePathMock,
}));
...
describe("runCli exit behavior", () => {
  ...
  it("does not force process.exit after successful routed command", async () => {
    ...
    await runCli(["node", "vilaro", "status"]);

    expect(tryRouteCliMock).toHaveBeenCalledWith(["node", "vilaro", "status"]);
