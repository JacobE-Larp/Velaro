...
export function hasAmbiguousGatewayAuthModeConfig(cfg: VilaroConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: VilaroConfig): void {
