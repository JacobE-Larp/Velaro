...
export function applyOpenrouterProviderConfig(cfg: VilaroConfig): VilaroConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: VilaroConfig): VilaroConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: VilaroConfig): VilaroConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: VilaroConfig): VilaroConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_CN_BASE_URL);
}

function applyMoonshotProviderConfigWithBaseUrl(cfg: VilaroConfig, baseUrl: string): VilaroConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: VilaroConfig): VilaroConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: VilaroConfig): VilaroConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: VilaroConfig): VilaroConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: VilaroConfig): VilaroConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: VilaroConfig): VilaroConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: VilaroConfig): VilaroConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: VilaroConfig): VilaroConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: VilaroConfig): VilaroConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: VilaroConfig): VilaroConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: VilaroConfig): VilaroConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: VilaroConfig): VilaroConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: VilaroConfig): VilaroConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: VilaroConfig): VilaroConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: VilaroConfig): VilaroConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: VilaroConfig): VilaroConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: VilaroConfig): VilaroConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: VilaroConfig): VilaroConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: VilaroConfig): VilaroConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: VilaroConfig): VilaroConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: VilaroConfig): VilaroConfig {
...
export function applyQianfanProviderConfig(cfg: VilaroConfig): VilaroConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: VilaroConfig): VilaroConfig {
...
export function applyModelStudioProviderConfig(cfg: VilaroConfig): VilaroConfig {
  return applyModelStudioProviderConfigWithBaseUrl(cfg, MODELSTUDIO_GLOBAL_BASE_URL);
}

export function applyModelStudioProviderConfigCn(cfg: VilaroConfig): VilaroConfig {
  return applyModelStudioProviderConfigWithBaseUrl(cfg, MODELSTUDIO_CN_BASE_URL);
}

export function applyModelStudioConfig(cfg: VilaroConfig): VilaroConfig {
  const next = applyModelStudioProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MODELSTUDIO_DEFAULT_MODEL_REF);
}

export function applyModelStudioConfigCn(cfg: VilaroConfig): VilaroConfig {
