...
export function applyProviderDefaultModel(cfg: VilaroConfig, modelRef: string): VilaroConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  maxTokens?: number;
}): { config: VilaroConfig; modelId: string; modelRef: string; profileId: string } {
