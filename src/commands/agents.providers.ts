...
function resolveDefaultAccountId(cfg: VilaroConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: VilaroConfig): boolean {
...
export function summarizeBindings(cfg: VilaroConfig, bindings: AgentBinding[]): string[] {
