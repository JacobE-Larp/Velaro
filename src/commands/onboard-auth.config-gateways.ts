...
export function applyVercelAiGatewayProviderConfig(cfg: VilaroConfig): VilaroConfig {
...
export function applyVercelAiGatewayConfig(cfg: VilaroConfig): VilaroConfig {
