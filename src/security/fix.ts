...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof VilaroConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: VilaroConfig; env: NodeJS.ProcessEnv }): {
  cfg: VilaroConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
