...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: VilaroConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: VilaroConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__vilaroMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__vilaroMcporterColdStartWarned;
  });
