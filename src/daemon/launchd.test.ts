...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.vilaro.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", VILARO_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.vilaro.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when VILARO_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.vilaro.gateway.plist",
    },
    {
      name: "uses profile-specific label when VILARO_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", VILARO_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.vilaro.jbphoenix.plist",
    },
    {
      name: "prefers VILARO_LAUNCHD_LABEL over VILARO_PROFILE",
      env: {
        HOME: "/Users/test",
        VILARO_PROFILE: "jbphoenix",
        VILARO_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from VILARO_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        VILARO_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty VILARO_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        VILARO_PROFILE: "myprofile",
        VILARO_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.vilaro.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
