...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.VILARO_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.VILARO_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.VILARO_SERVICE_MARKER = originalServiceMarker;
    }
  });
