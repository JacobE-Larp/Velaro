/**
 * Hook system for Vilaro agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __vilaro_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__vilaro_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
