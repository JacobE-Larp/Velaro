...
import { DEFAULT_VILARO_BROWSER_COLOR, DEFAULT_VILARO_BROWSER_PROFILE_NAME } from "./constants.js";
...
describe("startBrowserBridgeServer auth", () => {
  ...
  it("accepts x-vilaro-password when authPassword is set", async () => {
    await expectAuthFlow(
      { authPassword: "secret-password" },
      { "x-vilaro-password": "secret-password" },
    );
  });
