...
declare const __VILARO_VERSION__: string | undefined;
const CORE_PACKAGE_NAME = "vilaro";
...
export const VERSION = resolveBinaryVersion({
  ...
  injectedVersion: typeof __VILARO_VERSION__ === "string" ? __VILARO_VERSION__ : undefined,
  bundledVersion: process.env.VILARO_BUNDLED_VERSION,
});
