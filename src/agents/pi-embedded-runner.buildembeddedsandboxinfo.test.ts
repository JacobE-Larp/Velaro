...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/vilaro-sandbox",
    agentWorkspaceDir: "/tmp/vilaro-workspace",
    workspaceAccess: "none",
    runtimeId: "vilaro-sbx-test",
    runtimeLabel: "vilaro-sbx-test",
    containerName: "vilaro-sbx-test",
    ...
    browser: {
      ...
      containerName: "vilaro-sbx-browser-test",
    },
