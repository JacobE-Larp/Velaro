...
function resolveWatchPaths(workspaceDir: string, config?: VilaroConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: VilaroConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: VilaroConfig }) {
