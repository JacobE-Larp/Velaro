...
function resolveAdaptiveReadMaxBytes(options?: VelaroReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createVelaroReadTool(base, {
...
export function createVelaroReadTool(
  base: AnyAgentTool,
  options?: VelaroReadToolOptions,
): AnyAgentTool {
