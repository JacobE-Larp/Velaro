...
function resolveAdaptiveReadMaxBytes(options?: VilaroReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createVilaroReadTool(base, {
...
export function createVilaroReadTool(
  base: AnyAgentTool,
  options?: VilaroReadToolOptions,
): AnyAgentTool {
