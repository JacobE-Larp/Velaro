...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): VilaroConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: VilaroConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: VilaroConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
