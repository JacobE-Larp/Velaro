...
function resolveMainSessionKeyForSandbox(params: { cfg?: VilaroConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: VilaroConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`velaro sandbox explain --session ${runtime.sessionKey}`)}`,
  );
