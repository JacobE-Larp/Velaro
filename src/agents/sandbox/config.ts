...
const DEFAULT_SANDBOX_SSH_WORKSPACE_ROOT = "/tmp/vilaro-sandboxes";
...
export function resolveSandboxConfigForAgent(cfg?: VilaroConfig, agentId?: string): SandboxConfig {
