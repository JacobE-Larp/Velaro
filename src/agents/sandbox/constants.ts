...
export const DEFAULT_SANDBOX_IMAGE = "vilaro-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "vilaro-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "vilaro-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "vilaro-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "vilaro-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "vilaro-sandbox-browser";
