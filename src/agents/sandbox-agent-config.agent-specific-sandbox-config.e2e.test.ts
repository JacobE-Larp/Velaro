...
async function resolveContext(config: VilaroConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): VilaroConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
