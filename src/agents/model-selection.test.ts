...
function resolveAnthropicOpusThinking(cfg: VilaroConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<VilaroConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<VilaroConfig>) {
...
describe("model-selection", () => {
  ...
  describe("buildModelAliasIndex", () => {
    it("should build alias index from config", () => {
      const cfg: Partial<VilaroConfig> = {
        agents: {
          defaults: {
            models: {
