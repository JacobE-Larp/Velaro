...
function resolveAvatarSource(cfg: VilaroConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: VilaroConfig, agentId: string): AgentAvatarResolution {
