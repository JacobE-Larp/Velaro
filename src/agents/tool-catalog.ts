...
function buildCoreToolGroupMap() {
  ...
  const vilaroTools = CORE_TOOL_DEFINITIONS.filter((tool) => tool.includeInVilaroGroup).map(
    (tool) => tool.id,
  );
  return {
    "group:vilaro": vilaroTools,
