import type { VilaroConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveIdentityNamePrefix(cfg: VilaroConfig, agentId: string): string | undefined {
...
export function resolveIdentityName(cfg: VilaroConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[vilaro]";
}

/** Helper to extract a channel config value by dynamic key. */
function getChannelConfig(cfg: VilaroConfig, channel: string): Record<string, unknown> | undefined {
