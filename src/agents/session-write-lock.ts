...
const CLEANUP_STATE_KEY = Symbol.for("vilaro.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("vilaro.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("vilaro.sessionWriteLockWatchdogState");
