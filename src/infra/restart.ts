...
export function triggerVelaroRestart(): RestartAttempt {
  ...
  if (process.platform === "linux") {
    const unit = normalizeSystemdUnit(process.env.VILARO_SYSTEMD_UNIT, process.env.VILARO_PROFILE);
  ...
  const label =
    process.env.VILARO_LAUNCHD_LABEL || resolveGatewayLaunchAgentLabel(process.env.VILARO_PROFILE);
