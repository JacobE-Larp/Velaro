...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when VILARO_VERSION is not set", async () => {
  ...
  it("prefers VILARO_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over VILARO_SERVICE_VERSION when VILARO_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        VILARO_VERSION: " ",
        VILARO_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when VILARO_VERSION and VILARO_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        VILARO_VERSION: " ",
        VILARO_SERVICE_VERSION: "\t",
