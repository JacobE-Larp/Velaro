...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@vilaro", { botUsername: "vilaro" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@vilaro args", {
        botUsername: "vilaro",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "vilaro" })).toBe(
      "/help@otherbot",
    );
  });
