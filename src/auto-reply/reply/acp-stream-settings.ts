...
function resolveAcpStreamCoalesceIdleMs(cfg: VilaroConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: VilaroConfig): number {
...
export function resolveAcpProjectionSettings(cfg: VilaroConfig): AcpProjectionSettings {
