...
export function listBindings(cfg: VilaroConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: VilaroConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: VilaroConfig) {
