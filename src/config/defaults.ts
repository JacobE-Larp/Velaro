...
function resolveAnthropicDefaultAuthMode(cfg: VilaroConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: VilaroConfig): VilaroConfig {
...
export function applyTalkApiKey(config: VilaroConfig): VilaroConfig {
...
export function applyTalkConfigNormalization(config: VilaroConfig): VilaroConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: VilaroConfig): VilaroConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: VilaroConfig): VilaroConfig {
...
export function applyLoggingDefaults(cfg: VilaroConfig): VilaroConfig {
...
export function applyContextPruningDefaults(cfg: VilaroConfig): VilaroConfig {
...
export function applyCompactionDefaults(cfg: VilaroConfig): VilaroConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
