...
export const A2UI_PATH = "/__vilaro__/a2ui";

export const CANVAS_HOST_PATH = "/__vilaro__/canvas";

export const CANVAS_WS_PATH = "/__vilaro__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.vilaroCanvasA2UIAction.postMessage(...)
  // - Android: window.vilaroCanvasA2UIAction.postMessage(...)
  const handlerNames = ["vilaroCanvasA2UIAction"];
