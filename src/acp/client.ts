...
export async function createAcpClient(opts: AcpClientOptions = {}): Promise<AcpClientHandle> {
  ...
  const defaultServerCommand = entryPath ? process.execPath : "vilaro";
  ...
  await client.initialize({
    ...
    clientInfo: { name: "vilaro-acp-client", version: "1.0.0" },
  });
