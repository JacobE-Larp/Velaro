...
type ConfiguredBinding = NonNullable<VilaroConfig["bindings"]>[number];
...
function resolveBindingRecord(cfg: VilaroConfig, overrides: Partial<BindingRecordInput> = {}) {
  ...
  it("does not clear ACP metadata before reinitialize succeeds", async () => {
    ...
    sessionMetaMocks.readAcpSessionEntry.mockReturnValue({
      acp: {
        ...
        mode: "persistent",
        backend: "acpx",
        runtimeOptions: { cwd: "/home/bob/vilaro" },
      },
    });
