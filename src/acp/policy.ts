...
export function isAcpEnabledByPolicy(cfg: VilaroConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: VilaroConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: VilaroConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: VilaroConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: VilaroConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: VilaroConfig, agentId: string): boolean {
