...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: VilaroConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: VilaroConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: VilaroConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: VilaroConfig }): Promise<void> {
