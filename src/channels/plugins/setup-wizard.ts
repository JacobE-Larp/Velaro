...
export type ChannelSetupWizardStatus = {
  ...
  resolveConfigured: (params: { cfg: VilaroConfig }) => boolean | Promise<boolean>;
...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: VilaroConfig; accountId: string }) => boolean;
  apply: (params: { cfg: VilaroConfig; accountId: string }) => VilaroConfig | Promise<VilaroConfig>;
};
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: VilaroConfig; accountId: string }) => boolean;
  inspect: (params: { cfg: VilaroConfig; accountId: string }) => ChannelSetupWizardCredentialState;
  shouldPrompt?: (params: {
    cfg: VilaroConfig;
    accountId: string;
    credentialValues: ChannelSetupWizardCredentialValues;
  ...
  applyUseEnv?: (params: {
    cfg: VilaroConfig;
    accountId: string;
  }) => VilaroConfig | Promise<VilaroConfig>;
  applySet?: (params: {
    cfg: VilaroConfig;
    accountId: string;
    credentialValues: ChannelSetupWizardCredentialValues;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: VilaroConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: VilaroConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: VilaroConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: VilaroConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: VilaroConfig) => VilaroConfig;
