...
export function resolveScopedChannelMediaMaxBytes(params: {
  cfg: VilaroConfig;
  accountId?: string | null;
  resolveChannelLimitMb: (params: { cfg: VilaroConfig; accountId: string }) => number | undefined;
}): number | undefined {
...
export function createScopedChannelMediaMaxBytesResolver(channel: "imessage" | "signal") {
  return (params: { cfg: VilaroConfig; accountId?: string | null }) =>
...
>(params: {
  ...
  resolveMaxBytes: (params: { cfg: VilaroConfig; accountId?: string | null }) => number | undefined;
