...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: VilaroConfig): string | undefined {
  ...
  function listAccountIds(cfg: VilaroConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: VilaroConfig): string {
