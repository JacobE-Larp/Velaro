...
export function listChannelMessageActions(cfg: VilaroConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: VilaroConfig): ChannelMessageCapability[] {
