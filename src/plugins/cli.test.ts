...
vi.mock("./loader.js", () => ({
  loadVilaroPlugins: (...args: unknown[]) => mocks.loadVilaroPlugins(...args),
}));
...
describe("registerPluginCliCommands", () => {
  beforeEach(() => {
    ...
    mocks.loadVilaroPlugins.mockReturnValue({
      cliRegistrars: [
        {
  ...
  it("forwards an explicit env to plugin loading", () => {
    ...
    registerPluginCliCommands(program, {} as VilaroConfig, env);

    expect(mocks.loadVilaroPlugins).toHaveBeenCalledWith(
