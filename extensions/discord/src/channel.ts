...
import {
  ...
  type ChannelPlugin,
  type VilaroConfig,
} from "vilaro/plugin-sdk/discord";
...
function hasDiscordExecApprovalDmRoute(cfg: VilaroConfig): boolean {
...
export const discordPlugin: ChannelPlugin<ResolvedDiscordAccount> = {
  ...
  agentPrompt: {
    messageToolHints: () => [
      ...
      "- Forms: add `components.modal` (title, fields). Velaro adds a trigger button and routes submissions as new messages.",
    ],
  },
  messaging: {
