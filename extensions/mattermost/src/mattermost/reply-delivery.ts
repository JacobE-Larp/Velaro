import type { VilaroConfig, PluginRuntime, ReplyPayload } from "vilaro/plugin-sdk/mattermost";
import { getAgentScopedMediaLocalRoots } from "vilaro/plugin-sdk/mattermost";
