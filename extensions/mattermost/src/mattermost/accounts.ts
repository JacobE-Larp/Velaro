...
import { createAccountListHelpers, type VilaroConfig } from "vilaro/plugin-sdk/mattermost";
...
export function listEnabledMattermostAccounts(cfg: VilaroConfig): ResolvedMattermostAccount[] {
