...
function getChannelConfig(cfg: VilaroConfig): SynologyChatChannelConfig {
  return (cfg.channels?.[channel] as SynologyChatChannelConfig | undefined) ?? {};
}

function getRawAccountConfig(cfg: VilaroConfig, accountId: string): SynologyChatAccountRaw {
...
function isSynologyChatConfigured(cfg: VilaroConfig, accountId: string): boolean {
...
function resolveExistingAllowedUserIds(cfg: VilaroConfig, accountId: string): string[] {
