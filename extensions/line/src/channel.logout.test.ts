import type { VilaroConfig, PluginRuntime, ResolvedLineAccount } from "vilaro/plugin-sdk/line";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: VilaroConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: VilaroConfig; accountId: string }): Promise<{
