...
function setMSTeamsDmPolicy(cfg: VilaroConfig, dmPolicy: DmPolicy) {
...
function setMSTeamsAllowFrom(cfg: VilaroConfig, allowFrom: string[]): VilaroConfig {
...
function listMSTeamsGroupEntries(cfg: VilaroConfig): string[] {
