...
export function mergeSlackAccountConfig(cfg: VilaroConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: VilaroConfig): ResolvedSlackAccount[] {
