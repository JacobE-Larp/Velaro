import { normalizeAccountId, type IMessageAccountConfig } from "vilaro/plugin-sdk/imessage";
...
function mergeIMessageAccountConfig(cfg: VilaroConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: VilaroConfig): ResolvedIMessageAccount[] {
