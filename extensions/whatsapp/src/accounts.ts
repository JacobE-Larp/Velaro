...
export function listWhatsAppAuthDirs(cfg: VilaroConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: VilaroConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: VilaroConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: VilaroConfig): ResolvedWhatsAppAccount[] {
