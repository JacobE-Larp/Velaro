...
import { createAccountListHelpers, type VilaroConfig } from "vilaro/plugin-sdk/zalouser";
...
function mergeZalouserAccountConfig(cfg: VilaroConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: VilaroConfig; accountId?: string | null }) {
