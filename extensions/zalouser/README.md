...
Vilaro extension for Zalo Personal Account messaging via native `zca-js` integration.
...
```bash
vilaro channels login --channel zalouser
vilaro channels login --channel zalouser --account work
...
- Login not persisted: `vilaro channels logout --channel zalouser && vilaro channels login --channel zalouser`
- Probe status: `vilaro channels status --probe`
