import type { VilaroConfig, VilaroPluginApi } from "vilaro/plugin-sdk/thread-ownership";
...
function resolveOwnershipAgent(config: VilaroConfig): { id: string; name: string } {
