...
import { isSecretRef } from "vilaro/plugin-sdk/googlechat";
import { createAccountListHelpers, type VilaroConfig } from "vilaro/plugin-sdk/googlechat";
...
export function listEnabledGoogleChatAccounts(cfg: VilaroConfig): ResolvedGoogleChatAccount[] {
