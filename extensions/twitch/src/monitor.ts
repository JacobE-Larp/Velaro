...
import type { ReplyPayload, VilaroConfig } from "vilaro/plugin-sdk/twitch";
import { createReplyPrefixOptions } from "vilaro/plugin-sdk/twitch";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as VilaroConfig;
