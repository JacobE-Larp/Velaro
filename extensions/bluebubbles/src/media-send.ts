...
import { resolveChannelMediaMaxBytes, type VilaroConfig } from "vilaro/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: VilaroConfig; accountId?: string }): string[] {
