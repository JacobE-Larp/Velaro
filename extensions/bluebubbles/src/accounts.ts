...
import { createAccountListHelpers, type VilaroConfig } from "vilaro/plugin-sdk/bluebubbles";
...
export function listEnabledBlueBubblesAccounts(cfg: VilaroConfig): ResolvedBlueBubblesAccount[] {
