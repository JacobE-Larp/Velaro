...
This directory contains the **BlueBubbles external channel plugin** for Vilaro.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `vilaro/plugin-sdk` helpers.
