import { AllowFromListSchema, DmPolicySchema } from "vilaro/plugin-sdk/compat";
import { MarkdownConfigSchema, buildChannelConfigSchema } from "vilaro/plugin-sdk/nostr";
import { z } from "zod";
