...
} from "vilaro/plugin-sdk/account-id";
...
function resolveConfiguredDefaultNostrAccountId(cfg: VilaroConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: VilaroConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: VilaroConfig): string {
