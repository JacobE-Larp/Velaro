...
type WebSearchConfig = NonNullable<VilaroConfig["tools"]>["web"] extends infer Web
  ? Web extends { search?: infer Search }
    ? Search
    : undefined
  : undefined;

type WebFetchConfig = NonNullable<VilaroConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: VilaroConfig): WebSearchConfig {
...
function resolveFetchConfig(cfg?: VilaroConfig): WebFetchConfig {
...
export function resolveFirecrawlSearchConfig(cfg?: VilaroConfig): FirecrawlSearchConfig {
...
export function resolveFirecrawlFetchConfig(cfg?: VilaroConfig): FirecrawlFetchConfig {
...
export function resolveFirecrawlApiKey(cfg?: VilaroConfig): string | undefined {
...
export function resolveFirecrawlBaseUrl(cfg?: VilaroConfig): string {
  const search = resolveFirecrawlSearchConfig(cfg);
  const fetch = resolveFirecrawlFetchConfig(cfg);
  const configured =
...
export function resolveFirecrawlOnlyMainContent(cfg?: VilaroConfig, override?: boolean): boolean {
...
export function resolveFirecrawlMaxAgeMs(cfg?: VilaroConfig, override?: number): number {
