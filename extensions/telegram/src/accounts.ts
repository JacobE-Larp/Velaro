...
import type { TelegramAccountConfig, TelegramActionConfig } from "vilaro/plugin-sdk/telegram";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.VILARO_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: VilaroConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: VilaroConfig): string {
...
export function mergeTelegramAccountConfig(
  ...
  // See: https://github.com/vilaro/vilaro/issues/30673
...
export function listEnabledTelegramAccounts(cfg: VilaroConfig): ResolvedTelegramAccount[] {
