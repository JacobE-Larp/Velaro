...
export DISPLAY=:1
export HOME=/tmp/vilaro-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${VILARO_BROWSER_CDP_PORT:-${VILARO_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${VILARO_BROWSER_CDP_SOURCE_RANGE:-${VILARO_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${VILARO_BROWSER_VNC_PORT:-${VILARO_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${VILARO_BROWSER_NOVNC_PORT:-${VILARO_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${VILARO_BROWSER_ENABLE_NOVNC:-${VILARO_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${VILARO_BROWSER_HEADLESS:-${VILARO_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${VILARO_BROWSER_NO_SANDBOX:-${VILARO_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${VILARO_BROWSER_NOVNC_PASSWORD:-${VILARO_BROWSER_NOVNC_PASSWORD:-}}"
DISABLE_GRAPHICS_FLAGS="${VILARO_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${VILARO_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${VILARO_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
