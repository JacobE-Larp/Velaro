...
show_usage() {
    cat << EOF
clawlog - Vilaro Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Vilaro logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Vilaro logs flow through the macOS unified log (subsystem: ai.vilaro).
