...
# Output:
# - dist/Vilaro.app
# - dist/Vilaro-<version>.zip
# - dist/Vilaro-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.vilaro.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/Vilaro.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Vilaro-$VERSION.zip"
DMG="$ROOT_DIR/dist/Vilaro-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Vilaro-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Vilaro-$VERSION.dSYM.zip"
