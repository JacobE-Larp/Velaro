...
- Keep product names in English: Vilaro, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Vilaro Gateway, use “Gateway 网关”.
