...
const (
	envDocsPiExecutable     = "VILARO_DOCS_I18N_PI_EXECUTABLE"
	envDocsPiArgs           = "VILARO_DOCS_I18N_PI_ARGS"
	envDocsPiPackageVersion = "VILARO_DOCS_I18N_PI_PACKAGE_VERSION"
...
func getMaterializedPiRuntimeDir() (string, error) {
	...
	return filepath.Join(cacheDir, "vilaro", "docs-i18n", "pi-runtime", getMaterializedPiPackageVersion()), nil
}
