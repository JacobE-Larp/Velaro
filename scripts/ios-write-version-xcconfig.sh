...
- VILARO_GATEWAY_VERSION = exact package.json version
- VILARO_MARKETING_VERSION = short iOS/App Store version
- VILARO_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
VILARO_GATEWAY_VERSION = ${PACKAGE_VERSION}
VILARO_MARKETING_VERSION = ${MARKETING_VERSION}
VILARO_BUILD_VERSION = ${BUILD_NUMBER}
EOF
