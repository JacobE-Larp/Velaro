    ...
    <div class="login-gate">
      ...
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${faviconSrc} alt="Vilaro" />
          <div class="login-gate__title">Vilaro</div>
          ...
          <label class="field">
            ...
            <div class="login-gate__secret-row">
              <input
                ...
                placeholder="VILARO_GATEWAY_TOKEN (${t("login.passwordPlaceholder")})"
