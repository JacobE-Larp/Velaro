...
enum VilaroConfigFile {
    private static let logger = Logger(subsystem: "ai.vilaro", category: "config")
    ...
    static func stateDirURL() -> URL {
        VilaroPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        VilaroPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-vilaro-config-file",
            "event": "config.write",
