...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.vilaro", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Vilaro/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__vilaro__/a2ui/").absoluteString + "?platform=macos"
    }
