...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/vilaro/vilaro") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/vilaro/vilaro")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://vilaro.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "VilaroBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "VilaroBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "VilaroGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "VilaroGitCommit") as? String) ??
            "unknown"
    }
