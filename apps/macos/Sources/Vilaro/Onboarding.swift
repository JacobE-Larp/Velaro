...
enum UIStrings {
    static let welcomeTitle = "Welcome to Vilaro"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "vilaro.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: VilaroChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g vilaro@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: VilaroChatViewModel(
