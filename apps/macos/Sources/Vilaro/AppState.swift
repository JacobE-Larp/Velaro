...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = VilaroConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = VilaroConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: VilaroConfigFile.loadDict(),
        ...
        VilaroConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/vilaro"
        state.remoteCliPath = ""
        return state
    }
}
