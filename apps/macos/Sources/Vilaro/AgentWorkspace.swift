...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.vilaro", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return VilaroConfigFile.defaultWorkspaceURL() }
