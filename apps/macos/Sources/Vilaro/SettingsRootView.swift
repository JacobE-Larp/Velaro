...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .vilaroSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? VilaroPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? VilaroPaths.stateDirURL.path
...
extension Notification.Name {
    static let vilaroSelectSettingsTab = Notification.Name("vilaroSelectSettingsTab")
}
