...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.vilaro", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Vilaro windows, but below the system’s pop-up menus.
