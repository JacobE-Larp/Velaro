...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.vilaro", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.vilaro", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [VilaroChatMessage] = messages.compactMap { item in
