...
/// Menu contents for the Vilaro menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About Vilaro") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "Vilaro Not Configured"
        case .remote:
            "Remote Vilaro Active"
        case .local:
            "Vilaro Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .vilaroSelectSettingsTab, object: tab)
        }
    }
