...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.vilaro", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".vilaro/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.vilaroCommand(
            subcommand: "gateway",
