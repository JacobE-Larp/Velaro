...
import ai.vilaro.app.ui.mobileAccentBorderStrong
...
import ai.vilaro.app.ui.mobileSurface
import ai.vilaro.app.ui.mobileText
import ai.vilaro.app.ui.mobileTextSecondary
import ai.vilaro.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.vilaro.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.vilaro.app.ui.mobileFontFamily,
