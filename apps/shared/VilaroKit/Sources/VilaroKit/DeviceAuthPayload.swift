...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: VilaroProtocol.AnyCodable]?
    {
        ...
        return [
            "id": VilaroProtocol.AnyCodable(identity.deviceId),
            "publicKey": VilaroProtocol.AnyCodable(publicKey),
            "signature": VilaroProtocol.AnyCodable(signature),
            "signedAt": VilaroProtocol.AnyCodable(signedAtMs),
            "nonce": VilaroProtocol.AnyCodable(nonce),
        ]
    }
}
