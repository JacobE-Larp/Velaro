...
public enum VilaroTalkCommand: String, Codable, Sendable {
...
public struct VilaroTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct VilaroTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
