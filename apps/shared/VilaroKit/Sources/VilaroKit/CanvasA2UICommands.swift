...
public enum VilaroCanvasA2UICommand: String, Codable, Sendable {
...
public struct VilaroCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct VilaroCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
