...
public struct VilaroChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct VilaroChatSessionsDefaults: Codable, Sendable {
...
public struct VilaroChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct VilaroChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: VilaroChatSessionsDefaults?
    public let sessions: [VilaroChatSessionEntry]
    ...
    public init(
        ...
        sessions: [VilaroChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
