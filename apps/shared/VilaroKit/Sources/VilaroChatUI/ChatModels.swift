...
public typealias VilaroPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias VilaroPlatformImage = UIImage
#endif

public struct VilaroChatUsageCost: Codable, Hashable, Sendable {
...
public struct VilaroChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: VilaroChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(VilaroChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct VilaroChatMessageContent: Codable, Hashable, Sendable {
...
public struct VilaroChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [VilaroChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: VilaroChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [VilaroChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: VilaroChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(VilaroChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([VilaroChatMessageContent].self, forKey: .content) {
...
public struct VilaroChatHistoryPayload: Codable, Sendable {
...
public struct VilaroSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct VilaroSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [VilaroSessionPreviewItem]
}

public struct VilaroSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [VilaroSessionPreviewEntry]

    public init(ts: Int, previews: [VilaroSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct VilaroChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct VilaroChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct VilaroAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct VilaroChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct VilaroGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct VilaroPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: VilaroPlatformImage?
...
public struct VilaroChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
