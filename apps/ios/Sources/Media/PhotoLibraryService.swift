...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: VilaroPhotosLatestParams) async throws -> VilaroPhotosLatestPayload {
        ...
        var results: [VilaroPhotoPayload] = []
        ...
        return VilaroPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> VilaroPhotoPayload
    {
