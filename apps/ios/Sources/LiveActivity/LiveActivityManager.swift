...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.vilaro.ios", category: "LiveActivity")
    private var currentActivity: Activity<VilaroActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = VilaroActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<VilaroActivityAttributes>.activities
    ...
    private func updateCurrent(state: VilaroActivityAttributes.ContentState) {
    ...
    private func connectingState() -> VilaroActivityAttributes.ContentState {
        VilaroActivityAttributes.ContentState(
    ...
    private func idleState() -> VilaroActivityAttributes.ContentState {
        VilaroActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> VilaroActivityAttributes.ContentState {
        VilaroActivityAttributes.ContentState(
