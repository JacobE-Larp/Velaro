...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.vilaro.gateway"
    private static let nodeService = "ai.vilaro.node"
    private static let talkService = "ai.vilaro.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.vilaro.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.vilaro.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("vilaro-gateway.log")
    }
