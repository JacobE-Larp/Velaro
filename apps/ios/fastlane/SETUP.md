...
ASC_KEYCHAIN_SERVICE=vilaro-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.vilaro.client
# or
...
- The beta flow regenerates `apps/ios/Vilaro.xcodeproj` from `apps/ios/project.yml` before archiving
