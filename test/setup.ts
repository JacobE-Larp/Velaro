...
process.env.VILARO_PLUGIN_MANIFEST_CACHE_MS ??= "60000";
...
// Set HOME/state isolation before importing any runtime Vilaro modules.
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: VilaroConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;
