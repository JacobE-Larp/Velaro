...
Velaro treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.vilaro/settings/voicewake.json`

Shape:

```json
{ "triggers": ["velaro", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
