---
summary: "First-run setup flow for Velaro (macOS app)"
read_when:
...
For setup path options, see [Getting Started](/start/getting-started).
...
<Frame caption="Choose what permissions do you want to give Velaro">
...
<Step title="CLI">
  ...
  The app can install the global `velaro` CLI via npm/pnpm so terminal
