---
summary: "First-run setup flow for Vilaro (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Vilaro">
...
<Step title="CLI">
  ...
  The app can install the global `vilaro` CLI via npm/pnpm so terminal
