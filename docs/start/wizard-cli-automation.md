---
summary: "Scripted onboarding and agent setup for the Velaro CLI"
read_when:
...
Use `--non-interactive` to automate `velaro onboard`.
...
- Default workspaces follow `~/.vilaro/workspace-<agentId>`.
