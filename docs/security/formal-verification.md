...
summary: Machine-checked security models for Velaro’s highest-risk paths.
read_when:
...
This page tracks Velaro’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that Velaro enforces its
...
**What this is not (yet):** a proof that “Velaro is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/velaro-formal-models](https://github.com/vignesh07/vilaro-formal-models).
