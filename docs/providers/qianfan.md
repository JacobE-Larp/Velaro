---
summary: "Use Qianfan's unified API to access many models in Velaro"
read_when:
...
3. Velaro installed on your system
...
4. Copy the API key for use with Velaro

## CLI setup

```bash
velaro onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Velaro Configuration](/gateway/configuration)
