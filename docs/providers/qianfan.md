---
summary: "Use Qianfan's unified API to access many models in Vilaro"
read_when:
...
3. Vilaro installed on your system
...
4. Copy the API key for use with Vilaro

## CLI setup

```bash
vilaro onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Vilaro Configuration](/gateway/configuration)
