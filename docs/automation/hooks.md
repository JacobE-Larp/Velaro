...
- **📝 command-logger**: Logs all command events to `~/.vilaro/logs/commands.log`
...
- **Managed hooks** (`~/.vilaro/hooks/`): Shared across workspaces
...
**Output**: `<workspace>/memory/YYYY-MM-DD-slug.md` (defaults to `~/.vilaro/workspace`)
