...
- **Session store** (chat history + routing state) under `~/.vilaro/agents/<agentId>/sessions`.
...
available from `~/.vilaro/skills`. See [Skills: per-agent vs shared](/tools/skills#per-agent-vs-shared-skills).
...
- State dir: `~/.vilaro` (or `VILARO_STATE_DIR`)
- Workspace: `~/.vilaro/workspace` (or `~/.vilaro/workspace-<agentId>`)
- Agent dir: `~/.vilaro/agents/<agentId>/agent` (or `agents.list[].agentDir`)
...
- Workspace defaults to `~/.vilaro/workspace` (or `~/.vilaro/workspace-<profile>` when `VILARO_PROFILE` is set).
- State defaults to `~/.vilaro/agents/main/agent`.
...
```json5
{
  agents: {
    list: [
      { id: "alex", workspace: "~/.vilaro/workspace-alex" },
      { id: "mia", workspace: "~/.vilaro/workspace-mia" },
    ],
  },
  bindings: [
    {
...
```json5
{
  agents: {
    list: [
      { id: "main", workspace: "~/.vilaro/workspace-main" },
      { id: "coding", workspace: "~/.vilaro/workspace-coding" },
    ],
  },
  bindings: [
...
```json5
{
  agents: {
    list: [
      { id: "main", workspace: "~/.vilaro/workspace-main" },
      { id: "alerts", workspace: "~/.vilaro/workspace-alerts" },
    ],
  },
  bindings: [
...
```js
{
    ...
    list: [
      {
        ...
        default: true,
        name: "Home",
        workspace: "~/.vilaro/workspace-home",
        agentDir: "~/.vilaro/agents/home/agent",
      },
      {
        id: "work",
        name: "Work",
        workspace: "~/.vilaro/workspace-work",
        agentDir: "~/.vilaro/agents/work/agent",
      },
    ],
  },
  ...
  channels: {
    whatsapp: {
      accounts: {
        personal: {
          // Optional override. Default: ~/.vilaro/credentials/whatsapp/personal
          // authDir: "~/.vilaro/credentials/whatsapp/personal",
        },
        biz: {
          // Optional override. Default: ~/.vilaro/credentials/whatsapp/biz
    ...
    list: [
      {
        id: "chat",
        name: "Everyday",
        workspace: "~/.vilaro/workspace-chat",
        model: "anthropic/claude-sonnet-4-5",
      },
      {
        id: "opus",
        name: "Deep Work",
        workspace: "~/.vilaro/workspace-opus",
