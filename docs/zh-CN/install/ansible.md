...
summary: 使用 Ansible、Tailscale VPN 和防火墙隔离进行自动化、加固的 Velaro 安装
title: Ansible
x-i18n:
...
将 Velaro 部署到生产服务器的推荐方式是通过 **[velaro-ansible](https://github.com/vilaro/vilaro-ansible)** — 一个安全优先架构的自动化安装程序。
...
> **📦 完整指南：[github.com/velaro/velaro-ansible](https://github.com/vilaro/vilaro-ansible)**
>
> velaro-ansible 仓库是 Ansible 部署的权威来源。本页是快速概述。
...
# 或直接运行（然后手动执行 /tmp/velaro-setup.sh）
# ansible-playbook playbook.yml --ask-become-pass
```

## 更新 Velaro

Ansible 安装程序设置 Velaro 为手动更新。标准更新流程参见[更新](/install/updating)。
...
- [velaro-ansible](https://github.com/vilaro/vilaro-ansible) — 完整部署指南
