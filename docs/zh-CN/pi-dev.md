...
本指南总结了在 Velaro 中开发 Pi 集成的合理工作流程。
...
状态存储在 Velaro 状态目录下。默认为 `~/.vilaro`。如果设置了 `VILARO_STATE_DIR`，则使用该目录。
...
- https://docs.vilaro.ai/testing
- https://docs.vilaro.ai/start/getting-started
