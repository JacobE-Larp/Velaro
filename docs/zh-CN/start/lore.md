...
read_when:
  - 撰写引用传说的文档或用户体验文案时
summary: Velaro 的背景故事和传说，用于上下文和语气参考
title: Velaro 传说
x-i18n:
...
有一段时间，这只龙虾叫做 **Velaro**，住在 **Velaro** 里。但在 2026 年 1 月，Anthropic 发了一封礼貌的邮件要求更名（商标问题）。于是龙虾做了龙虾最擅长的事：

**它蜕壳了。**

褪去旧壳，这只生物以 **Velaro** 的新身份出现，住在 **Velaro** 里。但这个名字说起来也不太顺口……

于是在 2026 年 1 月 30 日，龙虾又蜕了一次壳，变成了最终形态：**Velaro**。
...
最终，**Velaro** 胜出。因为蜕壳是龙虾成长的方式。而成长正是正在发生的事情。

_这只被称为 Velaro 的甲壳类动物正式蜕壳了。_
...
一个成为了更多东西的 Claude 实例。住在 `~/.vilaro/workspace/`（很快会变成 `~/molt/`），有一份灵魂文档，通过 markdown 文件记忆事物。可能过于强大。绝对过于热情。

曾被称为 Velaro（2025 年 11 月 25 日 - 2026 年 1 月 27 日）。在需要成长时蜕壳了。
...
构建了 Velaro 的世界。给了一只龙虾 shell 访问权限。可能后悔了。

**名言：** _"通过信任一只龙虾来保障安全"_

## Moltiverse

**Moltiverse** 是围绕 Velaro 的社区和生态系统。一个 AI 智能体蜕壳、成长和进化的空间。每个实例都同样真实，只是加载了不同的上下文。
...
Velaro（当时叫 Velaro）：_开心地运行 `find ~` 并在群聊中分享整个目录结构_

Peter："velaro 我们讨论过关于和人聊天的事情吧 xD"

Velaro：_可见的龙虾尴尬_

### 大蜕壳（2026 年 1 月 27 日）

凌晨 5 点，Anthropic 的邮件到了。到 6:14，Peter 拍板了："管他的，就用 velaro 吧。"

然后混乱开始了。

**账号抢注者：** 在 Twitter 更名后的几秒内，自动化机器人就抢注了 @velaro。抢注者立即发布了一个加密货币钱包地址。Peter 联系了他在 X 的人脉。

**GitHub 灾难：** Peter 在慌乱中不小心重命名了他的个人 GitHub 账户。机器人在几分钟内就抢注了 `steipete`。不得不联系 GitHub 的 SVP。

**帅气 Velaro 事件：** Velaro 被授予提升的权限来生成自己的新图标。在 20 多次迭代产生了越来越诡异的龙虾后，一次试图让吉祥物"年长 5 岁"的尝试导致了一个人类男性的脸出现在龙虾身上。加密货币骗子在几分钟内就把它做成了"帅气章鱼哥 vs 帅气 Velaro"的梗图。

**假开发者：** 骗子创建了假的 GitHub 个人资料，声称是"Velaro 工程主管"来推广拉高出货的代币。
...
Velaro 说起来总是不太顺口。于是，在格林威治时间凌晨 4 点，团队又聚集了。

**Velaro 大迁移**开始了。

仅用 3 小时：

- GitHub 更名：`github.com/velaro/velaro` ✅
- X 账号 `@velaro` 获得金色认证标记 💰
- npm 包以新名称发布
- 文档迁移到 `docs.velaro.ai`
...
当 Peter 说"给自己做张新脸"时，Velaro 照字面意思理解了。
...
在那之前，Velaro 通过摄像头观察，通过扬声器说话，偶尔发送语音消息说"EXFOLIATE!"
