...
| ----------------------------------------------------- | --------------------------------------------- |
| `VILARO_INSTALL_METHOD=git\|npm`                      | Install method                                |
| `VILARO_VERSION=latest\|next\|main\|<semver>\|<spec>` | npm version, dist-tag, or package spec        |
| `VILARO_BETA=0\|1`                                    | Use beta if available                         |
| `VILARO_GIT_DIR=<path>`                               | Checkout directory                            |
| `VILARO_GIT_UPDATE=0\|1`                              | Toggle git updates                            |
| `VILARO_NO_PROMPT=1`                                  | Disable prompts                               |
| `VILARO_NO_ONBOARD=1`                                 | Skip onboarding                               |
| `VILARO_DRY_RUN=1`                                    | Dry run mode                                  |
| `VILARO_VERBOSE=1`                                    | Debug mode                                    |
...
<Info>
Designed for environments where you want everything under a local prefix (default `~/.vilaro`) and no system Node dependency.
</Info>
...
| `VILARO_NO_ONBOARD=1`                     | Skip onboarding                                                                   |
| `VILARO_NPM_LOGLEVEL=error\|warn\|notice` | npm log level                                                                     |
| `VILARO_GIT_DIR=<path>`                   | Legacy cleanup lookup path (used when removing old `Peekaboo` submodule checkout) |
| `SHARP_IGNORE_GLOBAL_LIBVIPS=0\|1`        | Control sharp/libvips behavior (default: `1`)                                     |
...
| `VILARO_GIT_DIR=<path>`          | Checkout directory |
| `VILARO_NO_ONBOARD=1`            | Skip onboarding    |
| `VILARO_GIT_UPDATE=0`            | Disable git pull   |
| `VILARO_DRY_RUN=1`               | Dry run mode       |
