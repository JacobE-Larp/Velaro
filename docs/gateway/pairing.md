...
Pairing state is stored under the Gateway state directory (default `~/.vilaro`):

- `~/.vilaro/nodes/paired.json`
- `~/.vilaro/nodes/pending.json`

If you override `VILARO_STATE_DIR`, the `nodes/` folder moves with it.
