---
summary: "Schema-accurate configuration examples for common Vilaro setups"
read_when:
  - Learning how to configure Vilaro
...
```json5
{
  agent: { workspace: "~/.vilaro/workspace" },
  channels: { whatsapp: { allowFrom: ["+15555550123"] } },
}
```

Save to `~/.vilaro/vilaro.json` and you can DM the bot from that number.
...
```json5
{
  ...
  session: {
    ...
    store: "~/.vilaro/agents/default/sessions/sessions.json",
    maintenance: {
      mode: "warn",
      pruneAfter: "30d",
      maxEntries: 500,
